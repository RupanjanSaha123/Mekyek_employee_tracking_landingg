...
const DownloadBox = ({ platform, version, requirements, downloadLink, features }) => {
  ...
  return (
    <div 
      className={`download-box animate-pop ${isHovered ? 'hovered' : ''}`}
      onMouseEnter={() => setIsHovered(true)}
      onMouseLeave={() => setIsHovered(false)}
    >
      <div className="box-header">
        <div className="platform-icon">
          <i className={`${getPlatformIconClass()} fa-lg`}></i> {/* Changed from fa-2x to fa-lg */}
        </div>
